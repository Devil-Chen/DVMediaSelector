...
import com.devil.test.BuildConfig;
...
public class ExoMediaPlayer extends AbstractPlayer  implements VideoListener, Player.EventListener {
    ...
    public void setLooping(boolean isLooping) {
        if (mInternalPlayer != null)
            mInternalPlayer.setRepeatMode(isLooping ? REPEAT_MODE_ALL : REPEAT_MODE_OFF);
    }
    ...
    public void setLoop(boolean isLoop) {
        if (mInternalPlayer != null){
            mInternalPlayer.setRepeatMode(isLoop ? REPEAT_MODE_ALL : REPEAT_MODE_OFF);
        }
    }
