...
public class StatusBarUtil {
     ...
     * @param mView
     */
    public static void setViewToStatusBarHeight(View mView){
        ViewGroup.LayoutParams sp_params = mView.getLayoutParams();

        sp_params.height= getStatusBarHeight(mView.getContext());
