...
public class TipLoadDialog
{
     ...
     * 默认成功图标
     */
    public int SUCCESS_ICON = R.mipmap.icon_dv_notify_done;
    /**
     * 默认失败图标
     */
    public int ERROR_ICON = R.mipmap.icon_dv_notify_error;
    /**
     * 默认提示信息图标
     */
    public int INFO_ICON = R.mipmap.icon_dv_notify_done;
    ...
    public TipLoadDialog(Context context, String info, int type)
    {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.dialog_dv_tip_view, null);
        ...
        if (type != ICON_TYPE_LOADING)
        {
            img.post(new Runnable()
            {
                ...
                public void run()
                {
                     ...
                     * 88太小  设置为200
                     */
                    int maxWidth = DisplayUtils.dip2px(mContext,200);
