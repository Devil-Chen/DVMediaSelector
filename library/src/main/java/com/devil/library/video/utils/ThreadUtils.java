...
public final class ThreadUtils {
     ...
     * @param <T>  The type of the task's result.
     */
    public static <T> void executeBySingle(final Runnable run) {
        getPoolByTypeAndPriority(TYPE_SINGLE).execute(run);
    }
     ...
     * @param <T>
     */
    public static <T> void executeByCached(final Runnable run) {
        getPoolByTypeAndPriority(TYPE_CACHED).execute(run);
    }
